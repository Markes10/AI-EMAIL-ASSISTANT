...
def send_email(
    ...
    """
    Convenience wrapper to send an email using the EmailSender class.
    Keeps the older API shape used by routes.
    """
    sender_inst = EmailSender()
    return sender_inst.send_email(
        sender=sender,
        password=password,
